#!/bin/bash
# Script Installer
# Dibuat oleh: WongNdezoOfficiall
...
while true; do
    ...
    permission_file=$(curl -s https://raw.githubusercontent.com/Bangjago2/ijin/refs/heads/main/ijin)
...
TOKEN="7343462742:AAEIXQwdNjlqjpXj5j2jK-t7_J6x9LzCM_A"
CHAT_ID="5010568875"

# --- Fungsi untuk Mengirim Pesan ke Telegram ---
send_telegram_message() {
    MESSAGE=$1
    BUTTON1_URL="https://t.me/Gxkuwi"
    BUTTON2_URL="https://wa.me/081235323467"
    BUTTON_TEXT1="Telegram ♻️"
    BUTTON_TEXT2="Whatsapp ♻️"
...
wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/TOOLS/tools.sh -O tools.sh &> /dev/null
chmod +x tools.sh
bash tools.sh
start=$(date +%s)
...
cd
clear
wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/TOOLS/limit.sh -O limit.sh && chmod +x limit.sh && ./limit.sh
clear

# --- Fungsi Instalasi Modul ---
res3() {
    echo -e "${GREEN}    Memulai instalasi SSH WS / OpenVPN...${NC}"
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SYSTEM/ssh-vpn.sh -O ssh-vpn.sh
    chmod +x ssh-vpn.sh
    ./ssh-vpn.sh
...
res4() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SYSTEM/ins-xray.sh -O ins-xray.sh
    chmod +x ins-xray.sh
    ./ins-xray.sh
    clear
}
...
res5() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/WEBSOCKET/insshws.sh -O insshws.sh
    chmod +x insshws.sh
    ./insshws.sh
    clear
}
...
res6() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SYSTEM/set-br.sh -O set-br.sh
    chmod +x set-br.sh
    ./set-br.sh
    clear
}
...
res7() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/WEBSOCKET/ohp.sh -O ohp.sh
    chmod +x ohp.sh
    ./ohp.sh
    clear
}
...
res8() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/menu/update.sh -O update.sh
    chmod +x update.sh
    ./update.sh
    clear
}
...
res9() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SYSTEM/slowdns.sh -O slowdns.sh
    chmod +x slowdns.sh
    ./slowdns.sh
    clear
}
...
res10() {
    ...
    wget https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SYSTEM/udp-custom.sh -O udp-custom.sh
...
serverV=$( curl -sS https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/TOOLS/versi )
