...
data_ip="https://raw.githubusercontent.com/Bangjago2/ijin/refs/heads/main/ijin"
checking_sc() {
...
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "  ${ORANGE}[1].${NC}\033[0;36m CREATE SSH & OpenVPN${NC}"
...
echo -e "  ${ORANGE}[5].${NC}\033[0;36m MEMBER SSH & OpenVPN ${NC}"
...
echo -e " ${ORANGE}[12].${NC}\033[0;36m DETAIL AKUN SSH ${NC}"
