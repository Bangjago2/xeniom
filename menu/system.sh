...
show_footer() {
    ...
    echo -e " ${COLOR1}║                  ${WH}• WONG NDEZO STORE •                ${COLOR1}║${NC}"
    echo -e " ${COLOR1}╚════════════════════════════════════════════════════╝${NC}"
}
...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/SLOWDNS/installsl.sh"
...
10 |10) clear ; wget -q https://raw.githubusercontent.com/Bangjago2/xeniom/refs/heads/main/rebuildpepesmenu && bash rebuildpepesmenu ;; 
00 |0) clear ; menu ;; 
